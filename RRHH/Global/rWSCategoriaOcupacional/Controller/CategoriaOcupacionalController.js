/*DAO*/
var CategoriaOcupacionalDao = require('./../DAO/CategoriaOcupacionalDAO')

/*model*/

var model = require('./../Model/CategoriaOcupacional')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        CategoriaOcupacionalDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        CategoriaOcupacionalDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    CategoriaOcupacionalDao.buscar(req.params.id, ok, error)
}
