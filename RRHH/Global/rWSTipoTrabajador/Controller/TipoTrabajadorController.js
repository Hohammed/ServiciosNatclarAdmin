/*DAO*/
var TipoTrabajadorDao = require('./../DAO/TipoTrabajadorDAO')

/*model*/

var model = require('./../Model/TipoTrabajador')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        TipoTrabajadorDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        TipoTrabajadorDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    TipoTrabajadorDao.buscar(req.params.id, ok, error)
}
