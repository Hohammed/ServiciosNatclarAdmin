/*DAO*/
var NivelAcademicoDao = require('./../DAO/NivelAcademicoDAO')

/*model*/

var model = require('./../Model/NivelAcademico')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        NivelAcademicoDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        NivelAcademicoDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    NivelAcademicoDao.buscar(req.params.id, ok, error)
}
