/*DAO*/
var TipoZonaDao = require('./../DAO/TipoZonaDAO')

/*model*/

var model = require('./../Model/TipoZona')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        TipoZonaDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        TipoZonaDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    TipoZonaDao.buscar(req.params.id, ok, error)
}
