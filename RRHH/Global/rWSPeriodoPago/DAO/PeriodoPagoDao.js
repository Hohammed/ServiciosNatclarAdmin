...
function mostrar(ok, error) {
    ...
    helper.query(sql, "rMaestro.SP_SEL_PERIODO_PAGO", [], ok, error)
}

function listar(ok, error) {
    helper.query(sql, "Maestro.SP_SEL_PERIODO_PAGO", [], ok, error)
}
...
function buscar(id, ok, error) {
    ...
    parameters.push(parameter);
    helper.query(sql, "Maestro.SP_SEL_PERIODO_PAGO", parameters, ok, error)
}
/*
