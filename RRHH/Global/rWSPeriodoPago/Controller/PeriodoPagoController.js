/*DAO*/
var PeriodoPagoDao = require('./../DAO/PeriodoPagoDao')

/*model*/

var model = require('./../Model/PeriodoPago')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        PeriodoPagoDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        PeriodoPagoDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    PeriodoPagoDao.buscar(req.params.id, ok, error)
}
