/*DAO*/
var TipoMedioPagoRRHHDao = require('./../DAO/TipoMedioPagoRRHHDao')

/*model*/

var model = require('./../Model/TipoMedioPagoRRHH')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        TipoMedioPagoRRHHDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        TipoMedioPagoRRHHDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    TipoMedioPagoRRHHDao.buscar(req.params.id, ok, error)
}
