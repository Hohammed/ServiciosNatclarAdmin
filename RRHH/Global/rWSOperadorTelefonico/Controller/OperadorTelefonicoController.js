/*DAO*/
var OperadorTelefonicoDao = require('./../DAO/OperadorTelefonicoDAO')

/*model*/

var model = require('./../Model/OperadorTelefonico')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        OperadorTelefonicoDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        OperadorTelefonicoDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    OperadorTelefonicoDao.buscar(req.params.id, ok, error)
}
