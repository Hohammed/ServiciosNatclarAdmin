/*DAO*/
var TipoViaDao = require('./../DAO/TipoViaDAO')

/*model*/

var model = require('./../Model/TipoVia')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        TipoViaDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        TipoViaDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    TipoViaDao.buscar(req.params.id, ok, error)
}
