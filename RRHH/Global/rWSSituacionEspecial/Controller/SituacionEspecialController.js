/*DAO*/
var SituacionEspecialDao = require('./../DAO/SituacionEspecialDao')

/*model*/

var model = require('./../Model/SituacionEspecial')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        SituacionEspecialDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        SituacionEspecialDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    SituacionEspecialDao.buscar(req.params.id, ok, error)
}
