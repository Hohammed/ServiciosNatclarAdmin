/*DAO*/
var GradoParentescoDao = require('./../DAO/GradoParentescoDAO')

/*model*/

var model = require('./../Model/GradoParentesco')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        GradoParentescoDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        GradoParentescoDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    GradoParentescoDao.buscar(req.params.id, ok, error)
}
