/*DAO*/
var TipoContratoDao = require('./../DAO/TipoContratoDAO')

/*model*/

var model = require('./../Model/TipoContrato')
...
listarTodo = function (req, res) {
    ...
    if(req.body.dsp==undefined){
        TipoContratoDao.listar(ok, error)
    }
    if(req.body.dsp!=undefined){
        TipoContratoDao.mostrar(ok, error)
    }
}
//GET - Buscar por ID
buscarById = function (req, res) {
    ...
    TipoContratoDao.buscar(req.params.id, ok, error)
}
